...
**Question:** Did the three model architectures classify the breed of dog in `Dog_01.jpg` to be the same breed? If not, report the differences in the classifications.
...
**Question:** Did each of the three model architectures classify the breed of dog in `Dog_01.jpg` to be the same breed of dog as that model architecture classified `Dog_02.jpg`? If not, report the differences in the classifications.
...
**Question:** Did the three model architectures correctly classify `Animal_Name_01.jpg` and `Object_Name_01.jpg` to not be dogs? If not, report the misclassifications.
...
**Question:** Based upon your answers for questions 1-3 above, select the model architecture that you feel did the best at classifying the four uploaded images. Describe why you selected that model architecture as the best on uploaded image classification.
